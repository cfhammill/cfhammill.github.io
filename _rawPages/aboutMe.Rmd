...
Currently, I'm a graduate student at Memorial University of Newfoundland in St. John's, Canada (hopefully graduating in August). I discovered my passion for computational statistics and data analysis when I began my graduate schooling and was introduced to R. Since then R has become my primary tool for playing with data sets large and small.
