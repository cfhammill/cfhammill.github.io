...
And what is really cool is that LyX can also be integrated (with a little effort) with R and you can produce documents just like Chris has shown in Markdown.  More on that below. But if you are not interested in LyX, LaTeX documents can be produced in RStudio (you need to install knitr and then simply File -> New -> R Sweave) or one of the various LaTeX editors like MiTeX (but you are on your own if you choose this path).
